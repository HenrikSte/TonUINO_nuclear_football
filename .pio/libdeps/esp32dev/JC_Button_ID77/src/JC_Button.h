...
class Button
{
    public:
        ...
        Button(uint8_t pin, uint32_t dbTime=25, uint8_t inputMode=INPUT_PULLUP, uint8_t invert=true)
            : m_pin(pin), m_dbTime(dbTime), m_inputMode(inputMode), m_invert(invert) {}
